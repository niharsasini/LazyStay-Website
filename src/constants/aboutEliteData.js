...
export const ELITE_OVERVIEW = [
  [
    ...
    "The hotel features 39 modern rooms , equipped with essential comforts including branded toiletries, Wi-Fi, wardrobe, and intercom. An elevator connects all 4 floors, supported by a smoke alarm-enabled, air-conditioned lobby.",
  ],
  [
